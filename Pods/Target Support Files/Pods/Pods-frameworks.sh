...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "Pods/AMSmoothAlert.framework"
  ...
  install_framework "Pods/Log.framework"
  install_framework "Pods/RavenSwift.framework"
  install_framework "Pods/SCLAlertView.framework"
  install_framework "Pods/SWBufferedToast.framework"
