//
//  MyDetailsTableViewController.swift
//  FlashFitPro
//
//  Created by Ali Raza on 11/8/15.
...
class MyDetailsTableViewController: UITableViewController {
    ...
    override func viewDidAppear(animated: Bool) {
        ...
        emailAddressLabel.text = Defaults["Email"].stringValue
    }
