...
//  FlashFitPro
//
//  Created by Haroon on 26/06/2015.
...
class ChatViewController: JSQMessagesViewController, UIActionSheetDelegate {
    ...
    */
    var outgoingBubbleImageView = JSQMessagesBubbleImageFactory().outgoingMessagesBubbleImageWithColor(UIColor(red: 84/255.0, green: 209/255.0, blue: 182/255.0, alpha: 1.0))
    
    var incomingBubbleImageView = JSQMessagesBubbleImageFactory().incomingMessagesBubbleImageWithColor(UIColor(red: 222/255.0, green: 221/255.0, blue: 228/255.0, alpha: 1.0))
    ...
    */
    ...
    func setDummyMessage(){
        let message = Message(text: "Hey there! Looking forward to our session tomorrow morning. This time we are going to focus more on strength training.", sender: "", imageUrl: senderImageUrl)
        messages.append(message)
